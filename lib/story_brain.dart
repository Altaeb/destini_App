...
//Step 25 - Change the storyNumber property into a private property so that only story_brain.dart
// has access to it. You can do this by right clicking on the name (storyNumber) and selecting
// Refactor -> Rename to make the change across all the places where it's used.
  int _storyNumber = 0;
//Step 7 - Uncomment the lines below to include storyData as a private property
// in StoryBrain. Hint: You might need to change something in story.dart to make this work.
...
//Step 8 - Create a method called getStory() that returns
// the first storyTitle from _storyData.
  String getStory() {
...
//Step 17 - Create a method called nextStory(), it should not have any outputs but it
// should have 1 input called choiceNumber which will be the choice number (int) made
// by the user.
  void nextStory(int choiceNumber) {
//Step 21 - Using the story plan, update nextStory() to change the storyNumber depending
// on the choice made by the user. e.g. if choiceNumber was equal to 1 and
